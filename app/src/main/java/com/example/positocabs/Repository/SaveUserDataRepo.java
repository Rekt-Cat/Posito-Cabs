...
public class SaveUserDataRepo {
    ...
    public void saveUserData(int userType, String name, String email, String gender, String dob, int rating, StorageReference storageReference, Uri imageUri) {
        //saving users data
        if (userType == 1) {
        ...
        //saving drivers data
            ...
            mUser = mAuth.getCurrentUser();
            readWriteUserDetails = new ReadWriteUserDetails(name, email, gender, dob, rating);
